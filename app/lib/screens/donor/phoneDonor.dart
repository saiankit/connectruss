...
class EnterPhoneNumberDonor extends StatefulWidget {
  @override
  _EnterPhoneNumberDonorState createState() => _EnterPhoneNumberDonorState();
}

String donorPhoneNumber;

class _EnterPhoneNumberDonorState extends State<EnterPhoneNumberDonor> {
                        ...
                        onPressed: () {
                          if (donorPhoneNumber == null ||
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      DonorBloodGroup(donorPhoneNumber)),
                            );
                          }
                        },
                        child: Container(
